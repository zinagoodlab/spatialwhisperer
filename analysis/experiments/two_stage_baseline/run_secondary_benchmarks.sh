...
TARGETS=(
    ...
    "$PD/results/pathocell_evaluation/spatialwhisperer_cellxgene_census__archs4_geo__hest1k__quilt1m/pannuke_summary/patch_metrics_from_scores_aggregated.json"
    "$PD/results/pathocell_evaluation/spatialwhisperer_quilt1m/lizard_summary/patch_metrics_from_scores_aggregated.json"
    "$PD/results/pathocell_evaluation/spatialwhisperer_quilt1m/pannuke_summary/patch_metrics_from_scores_aggregated.json"
