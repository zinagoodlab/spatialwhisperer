#!/bin/bash
#SBATCH --job-name=lambda_ablation_full_epoch_ctrl
#SBATCH --partition=cmackall
#SBATCH --cpus-per-task=4
#SBATCH --mem=16G
#SBATCH --time=72:00:00
#SBATCH --output=/scratch/users/moritzs/lambda_ablation_full_epoch_controller_%j.out
#SBATCH --error=/scratch/users/moritzs/lambda_ablation_full_epoch_controller_%j.err
...
snakemake --snakefile src/spotwhisperer_eval/Snakefile --profile sm7_slurm lambda_ablation_full_epoch_all
